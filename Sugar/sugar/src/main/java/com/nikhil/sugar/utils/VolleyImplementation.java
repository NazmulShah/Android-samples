...
public class VolleyImplementation {
    ...
    public void postRequest(String tag, String jsonString) {
        try {
            ...
            RetryPolicy policy = new DefaultRetryPolicy(WSConstants.volleyRequestTimeout, DefaultRetryPolicy.DEFAULT_MAX_RETRIES, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
    ...
    private Response.Listener demoResponseListener = new Response.Listener() {
        ...
        public void onResponse(Object o) {
            ...
            BaseResponseDTO responseDTO = POJOToJSON.fromJson(o.toString(), BaseResponseDTO.class);
            if (responseDTO.getMessage() != null && responseDTO.getMessage().equals(OtherConstants.invalidToken)) {
                Toast.makeText(context, "Please login again, token is expired", Toast.LENGTH_SHORT).show();
            }
